...
public struct Gallery: Codable, Hashable, Sendable {
    ...
    public init(id: Int64, title: String? = nil, url: String? = nil, thumbnail:String? = nil, info:String? = nil, width: Int? = nil, height: Int? = nil, roles:[Role], type:Int? = 0, uuid:Int64) {
        self.id = id
        self.title = title
        self.url = url
